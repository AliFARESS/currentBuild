  ...
  stage('Cmake')
    {
	    ...
	    cmakeBuild(
		       buildDir: 'build', buildType: 'debug', cleanBuild: true, generator: 'MinGW Makefiles', installation: 'CMake', sourceDir: 'src', steps: [[args: '-G "Eclipse CDT4 - MinGW Makefiles" -D"CMAKE_MAKE_PROGRAM:PATH=cmake/Toolchain/mingw32-make.exe" ./src']])
	    }
    }
	stage('Test')
	{
