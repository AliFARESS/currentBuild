  ...
  stage('Cmake')
    {
		...
		cmakeBuild( buildDir: 'build', buildType: 'debug', cleanBuild: true, generator: 'Eclipse CDT4 - MinGW Makefiles', installation: 'CMake', sourceDir: 'src', steps: [[args: 'cmake --build .']])
	    }
    }
	stage('Test')
	{
